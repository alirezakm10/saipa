...
} from "@/redux/services/contents/postCalssificationApi";
...
} from "@/redux/features/contents/postsClassificationSlice";
...
const CategoryKeywords: React.FC = () => {
  ...
  const {
    ...
    isFetching,
  } = useGetPostCatKeywordsQuery(selectedCat.id, {
  ...
  ] = useUpdatePostKeyToCatMutation<any>();
              ...
              >
                {attachedKeys.map((keyword: Keyword, idx: number) => (
                  <Chip
                    ...
                    onDelete={
                      hasPermission("Classification.edit") || keyword.isModified
