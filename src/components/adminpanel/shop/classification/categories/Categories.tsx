...
import { useAddCategoryMutation } from "@/redux/services/shop/productsClassificationApi";
import { AddCategories } from "./typescope";
import useToast from "@/hooks/useToast";
import { selectedProductCategory, setSelectedProductCategory } from "@/redux/features/shop/productsClassificationSlice";
...
export default function Categories() {
  ...
  const { data: categories, isLoading, isSuccess } = useGetCategoriesQuery(4);
  ...
  const handleCategorySelect = (node: Category) => {
    dispatch(setSelectedProductCategory(node))
