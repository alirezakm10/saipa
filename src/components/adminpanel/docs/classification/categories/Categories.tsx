...
import { useAddDocsCategoryMutation } from "@/redux/services/documents/docsClassificationApi";
...
export default function Categories() {
  ...
  const { data: categories, isLoading, isSuccess } = useGetDocsCategoriesQuery(10);
  ...
  const handleAddCategory = () => {
    addDocsCategory(addPaparentCategory);
  };
