...
const MainSliderList: React.FC<Props> = ({type}) => {
  ...
  function CustomToolbar() {
    return (
      <GridToolbarContainer sx={{ justifyContent: 'space-between' }}>
       { hasPermission("Promotion.create") && <Link href='/adminpanel/other/sliders/add-main-slider/0' >
          <Button
            variant='outlined'
            color='primary'
...
const activeSlider = sliders?.data.filter((item:any) => item.status === 1 && item.type === 0)[0]
